...
def clean_txt_file(filename):
    ...
    # Skip empty lines until valid sensor data appears
    data_lines = [line.strip() for line in data_lines if line.strip() and "sht_temp" in line]
    ...
    # Determine the cutoff timestamp (30th at 06:00:00)
    cutoff_datetime = pd.Timestamp(2025, 1, 30, 6, 0, 0)

    # Keep all rows before OR equal to `30th at 06:00`
